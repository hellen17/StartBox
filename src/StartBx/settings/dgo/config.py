...
DEFAULT_FILE_STORAGE = "StartBx.settings.dgo.utils.MediaRootS3BotoStorage"

STATICFILES_STORAGE = "StartBx.settings.dgo.utils.StaticRootS3BotoStorage"
...
PRIVATE_FILE_STORAGE = "StartBx.settings.dgo.utils.MediaRootS3BotoStorage"
